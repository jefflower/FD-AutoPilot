                    ...
                    <>
                        ...
                        {isAdmin && (
                            <>
                                ...
                                {/* Task 管理 */}
                                <NavButton
                                    label={t('nav.taskDashboard')}
                                    active={activeTab === 'task-dashboard'}
                                ...
                                />
                                <NavButton
                                    label={t('nav.taskDefinitions')}
                                    active={activeTab === 'task-definitions'}
                                    onClick={() => setActiveTab('task-definitions')}
                                    icon={
                                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
