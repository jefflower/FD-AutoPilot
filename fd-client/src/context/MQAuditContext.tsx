...
const { Provider: BaseProvider, useTaskContext } = createMQTaskContext({
    taskType: 'audit',
    eventName: 'mq-audit-request',
    startCommand: 'start_audit_mq_consumer',
    stopCommand: 'stop_audit_mq_consumer',
    statusCommand: 'get_audit_mq_consumer_status',
    completeCommand: 'complete_audit_task',
    defaultBatchSize: 1,
