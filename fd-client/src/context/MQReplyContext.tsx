...
const { Provider: BaseProvider, useTaskContext } = createMQTaskContext({
    taskType: 'reply',
    eventName: 'mq-reply-request',
    startCommand: 'start_reply_mq_consumer',
    stopCommand: 'stop_reply_mq_consumer',
    statusCommand: 'get_reply_mq_consumer_status',
    completeCommand: 'complete_reply_task',
    defaultBatchSize: 1,
